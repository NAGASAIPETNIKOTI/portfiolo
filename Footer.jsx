  ...
  return (
    ...
    <div className="text-center">
        ...
        <div className="w-max flex items-center gap-2 mx-auto">
            ...
            Petnikotinagasai@gmail.com
        </div>
    </div>
    <div className="text-center sm:flex items-center justify-between border-t border-gray-400 mx-[10%] mt-12 py-6">
        <p>© 2024 Nagasai. All rights reserved.</p>
        <ul className="flex items-center gap-10 justify-center mt-4 sm:mt-0">
            <li><a target='_blank' href="https://github.com/NAGASAIPETNIKOTI">GitHub</a></li>
            <li><a target='_blank' href="https://www.linkedin.com/in/pnagasai">LinkedIn</a></li>
