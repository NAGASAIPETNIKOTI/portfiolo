  ...
  return (
    ...
    <div className="grid grid-cols-auto gap-6 my-10">
        ...
        hover:shadow-black cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 dark:hover:bg-darkHover dark:hover:shadow-white">
            ...
            <a href="https://github.com/NAGASAIPETNIKOTI" className="flex items-center gap-2 text-sm mt-5">Read more <img src={right_arrow} alt="" className="w-4"/></a>
        </div>
        <div className="border border-gray-400 rounded-lg px-8 py-12
        hover:shadow-black cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 dark:hover:bg-darkHover dark:hover:shadow-white">
            <img src={mobile_icon} alt="" className="w-10"/>
            <h3 className="text-lg my-4 text-gray-700 dark:text-white">Mobile app</h3>
            <p className="text-sm text-gray-600 leading-5 dark:text-white/80">App development is the process of building, programming...</p>
        ...
        hover:shadow-black cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 dark:hover:bg-darkHover dark:hover:shadow-white">
            ...
            <h3 className="text-lg my-4 text-gray-700 dark:text-white">Income Tax</h3>
            <p className="text-sm text-gray-600 leading-5 dark:text-white/80"> excel is the process of calculations & know the data ...</p>
            <a href="" className="flex items-center gap-2 text-sm mt-5">Read more <img src={right_arrow} alt="" className="w-4"/></a>
        </div>
        <div className="border border-gray-400 rounded-lg px-8 py-12
        hover:shadow-black cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 dark:hover:bg-darkHover dark:hover:shadow-white">
